case $(uname -n) in
	...
	macOS)
		...
		VISUAL=nvim
		CLICOLOR=1
		export CLICOLOR FZF_DEFAULT_COMMAND FZF_CTRL_T_COMMAND PATH PAGER VISUAL HISTCONTROL HOMEBREW_INSTALL_CLEANUP HTTPIE_CONFIG_DIR LESS LESSHISTFILE LANG EDITOR LC_COLLATE
		;;
esac
