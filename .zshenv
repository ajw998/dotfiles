case $(uname -n) in
	macOS|Andrews-iMac.local)
		...
		CLICOLOR=1
		GOPATH=$HOME/go
		export CLICOLOR FZF_DEFAULT_COMMAND FZF_CTRL_T_COMMAND FZF_DEFAULT_OPTS PAGER VISUAL HISTCONTROL GOPATH HOMEBREW_INSTALL_CLEANUP HTTPIE_CONFIG_DIR LESS LESSHISTFILE LANG EDITOR LC_COLLATE 
		;;
esac
